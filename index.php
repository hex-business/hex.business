					...
					<div class="justify-content-center row">
						<div class="col-9">
							<div class="justify-content-center mb-5 mt-5 d-flex flex-wrap">
								...
								<div class="my-auto money-col col"><input type="number" pattern="\d*" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onkeydown="javascript: return event.keyCode == 69 ? false : true"  maxLength="12" disabled="disabled" class="enter-amount" id='enter-amount' min="0" placeholder="<?php echo $phrases['enter_amount'] ?>" /></div>
							...
							<div class="justify-content-center mb-5 d-flex flex-wrap">
								...
								<div class="my-auto money-col col"><input type="number" class="enter-amount" pattern="\d*"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onkeydown="javascript: return event.keyCode == 69 ? false : true"  maxLength="12" disabled='disabled' id='freeze-amount' placeholder="<?php echo $phrases['enter_amount'] ?>" /></div>
...
<div class="modal-content"><div class="modal-header"><div class="modal-title h4"><strong><?php echo $phrases['approve_token'] ?></strong></div><button type="button" class="close"><span aria-hidden="true" id='modal_close'>×</span><span class="sr-only">Close</span></button></div><div class="modal-body"><div class="justify-content-center row mobile-approvemodal"><div class="col-md-4"><img src="data:image/png;base64," class="img-fluid"></div><div class='mobile-approvediv'><div class="my-auto ">
	<input type="number" class="enter-amount" onkeydown="javascript: return event.keyCode == 69 ? false : true"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  maxLength="12" disabled='disabled' id='modal-amount' placeholder="<?php echo $phrases['enter_amount'] ?>" />
