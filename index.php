		...
		<div class="container-fluid  stickyback">
				...
				<div class="col">
					...
					<div class="d-flex flex-wrap no-padding justify-content-center">
						...
						<div class="download-buttons col-sm-4 col-12">
							...
							<div class="download row"><a><img src="./static/media/ios.4d7f4e71.png"
			...
			<div class="section bottom-shadow row"><a name="hexmoney"></a>
				<div class="col">
					...
					<div class="justify-content-center row">
						<div class="col-12"><p class="title"><?php echo $phrases['transform_hex_to_hex_money']; ?></p></div>
					</div>
					<div class="justify-content-center row">
						<div class="col-9">
							<div class="justify-content-center mb-5 mt-5 d-flex flex-wrap">
								...
								<div class="my-auto money-col col"><input type="number" pattern="\d*" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onkeydown="javascript: return event.keyCode == 69 || event.keyCode == 189 ? false : true"  maxLength="12" disabled="disabled" class="enter-amount" id='enter-amount' min="0" placeholder="<?php echo $phrases['enter_amount'] ?>" /></div>
							...
							<div class="justify-content-center mb-5 d-flex flex-wrap">
								...
								<div class="my-auto money-col col"><input type="number" class="enter-amount" pattern="\d*"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onkeydown="javascript: return event.keyCode == 69 || event.keyCode == 189 ? false : true"  maxLength="12" disabled='disabled' id='freeze-amount' placeholder="<?php echo $phrases['enter_amount'] ?>" /></div>
			...
			<div class="col">
				...
				<div class="justify-content-center row">
					<div class="col-md-1 col-sm-2 col-4"><a href="https://t.me/hexmobileapp"><img
							...
							class="w-75"></a></div>
					<div class="col-md-1 col-sm-2 col-4"><a href="https://twitter.com/HexBusiness/"><img
