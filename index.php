					...
					<div class="justify-content-center row">
						<div class="col-9">
							<div class="justify-content-center mb-5 mt-5 d-flex flex-wrap">
								...
								<div class="my-auto money-col col"><input class="enter-amount" id='enter-amount'maxlength="10" placeholder="<?php echo $phrases['enter_amount'] ?>"
								                                          type="text"></div>
							...
							<div class="justify-content-center mb-5 d-flex flex-wrap">
								...
								<div class="my-auto money-col col"><input class="enter-amount" maxlength="10" id='freeze-amount' placeholder="<?php echo $phrases['enter_amount'] ?>"
								                                          type="text"></div>
