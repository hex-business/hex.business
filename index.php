...
<div id="root">
	...
	<div class="App">
		<div class="menu" id="menu"><a name="menu"></a>
			...
			<!-- pls fix font and font weight that's not showing correctly in menu text + pls see https://hex.business as reference for graphical depicted compare and contrast -->
			...
			<div class="menu-item " >
				<span lang="en">hex AA lobby</span> (10% 回馈)
			</div>
			...
			<!-- add >>> lang="en-US" <<< inline where only the en-US text appears and then leave the Chinese one alone since that is the document's default declared, not sure the correct way pls help -->
			<div class="menu-item " lang="en">
				<span lang="en">hex stable</span> (即将推出)
			</div>
			...
			<!-- add >>> lang="en-US" <<< inline where only the en-US text appears and then leave the Chinese one alone since that is the document's default declared, not sure the correct way pls help -->
			<div class="menu-item ">
				<span lang="en">hex bet</span> (即将推出)
			</div>
		...
		<div class="headroom-wrapper" style="height: 45px;">
			...
			<div style="position: relative; top: 0px; left: 0px; right: 0px; z-index: 1; transform: translate3d(0px, 0px, 0px);"
				...
				<nav class="App-header bottom-shadow navbar navbar-expand navbar-light">
					...
					<a href="#" class="navbar-brand">
						...
						<img src="data:image/png;base64,"
						     alt="hex business logo" class="top-image" lang="en"> Beta
		...
		<div class="container-fluid">
				...
				<div class="no-padding col">
					...
					<div class="d-md-block row">
						...
						<div class="col">
							...
							<div class="row">
								...
								<div class="lets-talk col-md-6">
									<p>我们在 <strong lang="en">hex.business</strong> 谈谈生意</p>
								</div>

								<div class="col-md-6">
									<img src="./static/media/mobile.fb8b964b.png" class="top-phone img-fluid"
									     alt="hex mobile app">
								</div>
					...
					<div class="d-md-block inline-tables">
						<div class="col-md-6 col-12">
							...
							<div class="table-cell stat-text table-margin row">
								<div class="stat-cell col-4">锁定数量</div>
								<div class="stat-cell col-3">
							...
							<div class="table-cell stat-text table-margin row">
								<div class="stat-cell col-4">流通数量</div>
								<div class="stat-cell col-3">
						...
						<div class="col-md-6 col-12">
							<div class="table-title stat-text row"><strong>普及放大器 <span lang="en">AA</span> </strong>
							</div>
							<div class="table-cell stat-text row">
								<div class="stat-cell col-4"><span lang="en">AA POOL</span> 价格</div>
							...
							<div class="table-cell stat-text row">
								<div class="stat-cell col-4"><span lang="en">UNISWAP</span> 价格</div>
								<div class="stat-cell col-6">
				...
				<div class="col">
					...
					<div class="d-flex flex-wrap no-padding justify-content-center">
						...
						<div class="download-buttons col-sm-4 col-12">
							<div class="download row"><a href="https://hexbusiness.net/APK/hexmobileAndroid.apk"><img
											src="./static/media/apk.d5bffc48.png" class="download-button"
											alt="download hex mobile app APK"></a></div>
							<div class="download row"><a
										href="https://play.google.com/store/apps/details?id=com.hexbusiness.hexmobile"><img
											src="./static/media/gpbutton.png" class="download-button"
											alt="download hex mobile on Google Play"></a></div>
							<div class="download row"><a href="/"><img src="./static/media/ios.4d7f4e71.png"
							                                           class="download-button"
							                                           alt="download for iOS coming soon"></a></div>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col">
							<div class="justify-content-center row">
								<div class="col-md-2 col-4"><img src="./static/media/HEXCredit.f7a7e4b9.png"
								                                 class="section-icon img-fluid" alt="hex credit logo">
								</div>
							</div>
							<p class="title"><strong>hex.business</strong> 分散式信贷平台 </p>
							<div class="justify-content-center row"><img
										src="./static/media/creditcards.53d7f34f.png" class="credit-cards"
										alt="hex on cards"></div>
						</div>
					</div>
				</div>
			</div>
			<div class="section bottom-shadow row"><a name="hexmoney"></a>
				<div class="col">
					<div class="justify-content-center row">
						<div class="col-md-2 col-4"><img src="./static/media/HEXMoney.8a7b779a.png"
						                                 class="section-icon img-fluid" alt="hex money"></div>
					</div>
					<div class="justify-content-center row">
						<div class="col-9"><p class="title"> 把 <strong lang="en">HEX</strong> 转换成 <strong> <span
					...
					<div class="justify-content-center row">
						<div class="col-9">
							<div class="justify-content-center mb-5 mt-5 d-flex flex-wrap">
								<div class="my-auto money-col money-text col-md-auto col-12"><strong>传送</strong></div>
								<div class="my-auto money-col col"><input class="enter-amount" placeholder="输入数量"
								                                          type="text"></div>
								<div class="my-auto money-text money-col col"><strong lang="en">HEX</strong></div>
								<div class="my-auto money-col money-text col-sm-auto"><strong>可收到 0 <span
												lang="en">HXY.</span></strong></div>
								<div class="my-auto money-col col-sm-auto">
									<button type="button" class="action-button btn btn-light">转换</button>
								</div>
							</div>
							<div class="justify-content-center mb-5 d-flex flex-wrap">
								<div class="my-auto money-text money-col col-md-auto col-12"><strong>我想要</strong></div>
					...
					<div class="row"><p class="mb-5 title"><strong>您的钱包余额： 0 <span lang="en">HXY</span> </strong></p>
					</div>
			...
			<div class=" bottom-shadow row">
				<div class="col">
					<div class="justify-content-center row">
						<div class="col-10"><p class="project-title title"> 参考一下其他的 <strong
										lang="en">hex.business</strong> 项目
							</p></div>
					</div>
		...
		<div class="section bottom-shadow row"><a name="hexplay"></a>
			<div class="col">
				...
				<div class="row"><p class="title"> 关于 <strong lang="en">HEX</strong></p></div>
		...
		<div class="section bottom-shadow  row">
			<div class="col">
				<div class="justify-content-center row"><p> 欢迎捐款到: 0x1EF0Bab01329a6CE39e92eA6B88828430B1Cd91f </p>
				</div>
				<div class="justify-content-center row">
					<div class="col-md-2 col-sm-5 col-6"><img
								src="./static/media/hexbusinessqrcode.8f0141ec.jpg" class="img-fluid"
								alt="donate to this project"></div>
				</div>
			</div>
		</div>
		<p> 此网站仍在Beta试用阶段。使用风险请自负。</p>
	</div>
</div>
