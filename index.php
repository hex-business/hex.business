					...
					<div class="justify-content-center row">
						<div class="col-9">
							<div class="justify-content-center mb-5 mt-5 d-flex flex-wrap">
								...
								<div class="my-auto money-col col"><input type="number" pattern="\d*" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onkeydown="javascript: return event.keyCode == 69 || event.keyCode == 189 || event.keyCode == 187 ? false : true"  maxLength="12" disabled="disabled" class="enter-amount" id='enter-amount' min="0" placeholder="<?php echo $phrases['enter_amount'] ?>" /></div>
